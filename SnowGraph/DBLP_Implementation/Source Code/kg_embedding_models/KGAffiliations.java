...
static String stopwordspath;
	...
	public static void main(String[] args) {
		// Input-files:
		stopwordspath = "data_dblp/embd/input/stopwords-en.txt";	String gridpath = "data_dblp/embd/input/grid.json";
		String kgauthppath = "data_dblp/embd/kg_authors_p.txt";	String afLabelpath = "data_dblp/embd/afLabels.txt";
		String afpath = "data_dblp/embd/affiliations.txt";	String sgOrgpath = "data_dblp/embd/scigraphOrganization.txt";
		
		// Output-files:
		String kgorgpath = "data_dblp/embd/kg_organizations.txt";	String kgauthorgpath = "data_dblp/embd/kg_auth_orgs.txt";
		
		// Temporary files:
		String authorgpath = "auth_org.txt";	String afnewpath = "affiliations_new.txt"; 		
		String orgpath = "organizations.txt";	String orglistpath = "org-list_grid.txt";	
		String kgorgcpath = "kg_organizations_complete.txt";	
		...
		for(String[] org : orgs)	appendToFile(kgorgcpath, org[0] + "\t" + org[1] + "\n");
		for(String[] auth : authors)	appendToFile(kgauthorgpath, auth[0] + "\t" + auth[1] + "\n");
		
		// Remove temporary files:
		File tmp1 = new File(authorgpath);	tmp1.delete();	File tmp2 = new File(afnewpath);	tmp2.delete();
		File tmp3 = new File(orgpath);	tmp3.delete();	File tmp4 = new File(orglistpath);	tmp4.delete();
		File tmp5 = new File(kgorgcpath);	tmp5.delete();
	}
}
