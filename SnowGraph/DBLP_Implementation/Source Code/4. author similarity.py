...
def SimilarityOfAuthors(auth1,auth2):
	...
	#MAX():
	#if TotalX > TotalY:
	#	counterEither = TotalX
	#else:
	#	counterEither = TotalY   
	
	#UNION():     
 	counterEither = TotalX + TotalY
    if counterEither == 0:
        return 0
